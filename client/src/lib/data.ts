export const wilayas = [
  "الجزائر", "وهران", "قسنطينة", "سطيف", "عنابة", "بجاية", "تيزي وزو", "ورقلة",
  "باتنة", "تلمسان", "بشار", "سكيكدة", "البليدة", "جيجل", "مستغانم", "المدية",
  "الشلف", "معسكر", "سعيدة", "تبسة", "بسكرة", "الأغواط", "غرداية", "البويرة",
  "الطارف", "تيارت", "سوق أهراس", "أم البواقي", "خنشلة", "برج بوعريريج",
  "غليزان", "الوادي", "ميلة", "تيسمسيلت", "المسيلة", "الجلفة", "عين الدفلى",
  "النعامة", "عين تموشنت", "تمنراست", "إليزي", "تندوف", "أدرار",
  "سيدي بلعباس", "عين صالح", "بني عباس", "إن قزام", "توقرت", "جانت", "المغير", "المنيعة"
];
